...
| 服务 | 地址 | 说明 |
|------|------|------|
| 前端 (Vite) | http://localhost:5173 | React 开发服务器 |
| 后端 (Express) | http://localhost:5001 | API 服务器 |
| WebSocket | ws://localhost:5001 | 实时通信 |

### 5. 开始使用

打开 http://localhost:5173，在左侧输入框中描述你想要的 3D 模型：
